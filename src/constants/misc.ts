...
export const UYELIK_SOZLESMESI: ArticleProps = {
...
Üye olmak oldukça basit ve hızlı bir işlemdir. Üye olmanız hiç bir yükümlülük altına girdiğinizi ifade etmez. Ancak alışveriş yapmadan önce Satış sözleşmesini dikkatle okuyunuz. Dilediğiniz zaman üyeliğinizi sonlandırma hakkına sahipsiniz.`,
    ...
    {
      title: "Üyelik İptali",
      content: `Üye dilediği zaman üyeliğini sonlandırma hakkına sahiptir. Üyeliğinizi sonlandırdıktan sonra sitemiz ile tüm ilişkiniz kesilmiş olacaktır.
...
Örneğin: Çalıştığınız şirketin farklı şubelerinde bulunacağınız dönemlerde veya yazlıkta kaldığınız dönemlerde. Yâda faturanızın size siparişinizin bir arkadaşınıza ulaşmasını istiyorsanız    
`,
    },
    {
      title: "Ürün Yorumları",
      content: `Her üye ürünlere yorum yazabilir. Bilgilerinizi ve tecrübelerinizi diğer kullanıcılarla paylaştıkça, alışveriş daha keyifli ve bilinçli olacaktır. Müşteri yorumları tarafsız ve tecrübeye dayalı olacağı için daha bilinçli alışveriş ortamı doğacaktır.
...
export const SATIS_SOZLESMESI: ArticleProps = {
...
Satış Sözleşmesi gmvahap.com ile Müşteri arasındaki Sanal Ortamda Satış Sözleşmesidir.`,
    ...
    },
    {
      ...
      content: `5.1 - ALICI, Madde 4te belirtilen sözleşme konusu ürünün temel nitelikleri, satış fiyatı ve ödeme sekli ile teslimata ilişkin tüm ön bilgileri okuyup bilgi sahibi olduğunu ve elektronik ortamda gerekli teyidi verdiğini beyan eder. 
...
5.4 " SATICI , sözlesme konusu ürünün saglam, eksiksiz, sipariste belirtilen niteliklere uygun ve varsa garanti belgeleri ve kullanim kilavuzlari ile birlikte teslim edilmesinden sorumludur.
